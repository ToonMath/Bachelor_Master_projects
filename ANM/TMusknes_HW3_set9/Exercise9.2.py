...
ax.semilogy(svd[1]**2,label='ground state')
ax.set_ylabel('$p_k$')
ax.set_title('probability values ($p_k$)')

ax2.semilogy(normconst*svd[1]**2,label='ground state')
ax2.set_xlabel('n')
ax2.set_ylabel('$p_k$')
ax2.set_title('probability values ($p_k$) normalised')
...
normconst = 1/sumeig
ax.semilogy(svdrand[1]**2,label='random matrix')
ax2.semilogy(normconst*svdrand[1]**2,label='random matrix')
